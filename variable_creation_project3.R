...
# samecard = sqldf("
#                   SELECT a.Recordnum,a.Date,a.Amount,b.Recordnum,b.Date,b.Amount,
#               a.Date-b.Date as aa,
#               (CASE WHEN a.Date = b.Date THEN b.Amount ELSE NULL END) AS amount_1
#               FROM data a, data b
#               WHERE a.Cardnum = b.Cardnum
#               AND a.Recordnum > b.Recordnum
#               AND a.Cardnum=5142190439
#               ")
...
data1 = sqldf("
                   SELECT a.Recordnum,
                   a.Amount, 
                  (CASE WHEN a.Date = b.Date AND a.Recordnum = b.Recordnum THEN 0
...
data3 = sqldf("
              SELECT a.Recordnum,
              a.Amount, 
              (CASE WHEN a.Date - b.Date BETWEEN 0 AND 2 AND a.Recordnum = b.Recordnum THEN 0
...
data7 = sqldf("
              SELECT a.Recordnum,
              a.Amount, 
              (CASE WHEN a.Date - b.Date BETWEEN 0 AND 6 AND a.Recordnum = b.Recordnum THEN 0
...
data14 = sqldf("
              SELECT a.Recordnum,
               a.Amount, 
               (CASE WHEN a.Date - b.Date BETWEEN 0 AND 13 AND a.Recordnum = b.Recordnum THEN 0
...
data28 = sqldf("
              SELECT a.Recordnum,
               a.Amount, 
               (CASE WHEN a.Date - b.Date BETWEEN 0 AND 27 AND a.Recordnum = b.Recordnum THEN 0
